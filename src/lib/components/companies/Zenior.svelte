...
<div class="prose">
	...
	<p>
		<strong>
			...
			forbedring av utviklingsprosesser, Oppsett og optimalisering av utviklingsmiljø, Etablering og
			effektivisering av driftsmiljø og prosesser, Java, Android, iOS, .Net
		</strong>
	</p>
</div>
